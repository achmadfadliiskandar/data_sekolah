...
<form method="POST" action="simpansiswa.php">
    ...
    <input type="date" class="form-control" id="ttl" nama="ttl">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
    <textarea name="keterangan_siswa" id="keterangan_siswa" cols="156" rows="10"></textarea>
    </div>
    <div class="mb-3">
    <label for="pembayaran" class="form-label">Pembayaran</label>
    <input type="text" class="form-control" id="pembayaran" name="pembayaran" >
    </div>
    <button type="submit" name="simpansiswa" class="btn btn-primary">Submit</button>
</form>
</div>
